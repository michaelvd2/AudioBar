...
final class ReleasePackagingScriptTests: XCTestCase {
    ...
    func testReleasePackagingCarriesCurrentBundleVersion() throws {
        ...
        XCTAssertTrue(script.contains("APP_VERSION=\"0.1.2\""))
        XCTAssertTrue(script.contains("BUILD_NUMBER=\"3\""))
    ...
    func testDownloadPageLinksToCurrentRelease() throws {
        ...
        XCTAssertTrue(page.contains("/releases/download/v0.1.2/AudioBar-notarized.zip"))
        XCTAssertFalse(page.contains("/releases/download/v0.1.1/AudioBar-notarized.zip"))
    }
