...
final class ReleasePackagingScriptTests: XCTestCase {
    ...
    func testReleasePackagingCarriesCurrentBundleVersion() throws {
        ...
        XCTAssertTrue(script.contains("APP_VERSION=\"0.1.4\""))
        XCTAssertTrue(script.contains("BUILD_NUMBER=\"5\""))
    ...
    func testDownloadPageLinksToCurrentRelease() throws {
        ...
        XCTAssertTrue(page.contains("/releases/download/v0.1.4/AudioBar-notarized.zip"))
        XCTAssertFalse(page.contains("/releases/download/v0.1.3/AudioBar-notarized.zip"))
    }
